    ...
    <div className="flex flex-col min-h-screen bg-[#f5f6f8]">
      ...
      <section className="relative h-[420px] md:h-[520px] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/mission/unsplash_Hg8fLXkdbmU.png')" }}>
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-2xl md:text-4xl font-bold tracking-wide mb-4">BUILDING SCHOOLS, STRENGTHENING COMMUNITIES<br />
      ...
      <section className="bg-white py-16 px-4">
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-xl font-bold mb-2 text-orange-500 tracking-widest">ABOUT US</h2>
      ...
      <section id="impact" className="py-12 px-4 bg-gradient-to-r from-[#f4c8a4] to-[#e3a678]">
        <div className="container mx-auto">
          <h3 className="text-center text-2xl font-bold mb-10 text-gray-800">OUR IMPACT</h3>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <div className="bg-white rounded-2xl shadow-md px-8 py-8 text-center min-w-[180px] border-t-8 border-orange-400">
            ...
            <div className="bg-white rounded-2xl shadow-md px-8 py-8 text-center min-w-[180px] border-t-8 border-blue-400">
              <div className="text-3xl font-bold text-blue-400 mb-2">1M+</div>
              <div className="text-gray-700 font-semibold">SQ FT BUILT</div>
            </div>
            <div className="bg-white rounded-2xl shadow-md px-8 py-8 text-center min-w-[180px] border-t-8 border-[#e3a678]">
      ...
      <section className="bg-white py-16 px-4">
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-xl font-bold mb-2 text-orange-500 tracking-widest">OUR MISSION</h3>
